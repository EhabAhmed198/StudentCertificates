...
public final class StudentBroadcastReceiver extends BroadcastReceiver {
  Context context;
    SharedPreferences sharedPreferences,sharedPreferences1,sharedPreferences2,
            sharedPreferences5,sharedPreferences6,sharedPreferences7,sharedPreferences8,sharedPreferences9,sharedPreferences10,sharedPreferences11,sharedPreferences12,sharedPreferences13;
    SharedPreferences.Editor editor,editor1,editor10,editor11,editor12,editor13;
...
//                checktable(context); // dont work
//                checkcourse(context);
//                checklibraryBook(context);
//                checkexams(context);
//                checkcompition(context);
//                checknews(context);
//                checkAriciles(context);
...
final SharedPreferences.Editor editor7=sharedPreferences7.edit();
    ...
    private void checkAriciles(final Context context) {
//        sharedPreferences13=context.getSharedPreferences("number_ariticles",Context.MODE_PRIVATE);
//        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.LOLLIPOP_MR1){
//            url = "https://ehab01998.com/getcount.php?type="+6;
//        }else {
//            url = "http://ehab01998.com/getcount.php?type="+6;
//        }
//        StringRequest request111=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
//            @Override
//            public void onResponse(String response) {
//                Toast.makeText(context, "ok..   "+response, Toast.LENGTH_SHORT).show();
//            }
//        }, new Response.ErrorListener() {
//            @Override
//            public void onErrorResponse(VolleyError error) {
...
//            }
//        });
//        requestQueue.add(request111);

        GsonBuilder builder=new GsonBuilder();
        builder.setLenient();
        Gson gson=builder.create();
        Retrofit retrofit=new Retrofit.Builder()
                .baseUrl("http://ehab01998.com").addConverterFactory(GsonConverterFactory.create(gson))
                .build();
        ApiConfig apiConfig=retrofit.create(ApiConfig.class);
        apiConfig.getNumArticles().enqueue(new Callback<String>() {
            @Override
