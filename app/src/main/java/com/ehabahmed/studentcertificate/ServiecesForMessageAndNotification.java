...
public class ServiecesForMessageAndNotification extends Service {
    private Timer timer;
    private TimerTask timerTask;
    private String Uid;

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public ServiecesForMessageAndNotification() {
        super();
    }
    ...
    private SharedPreferences.Editor editor, editor1, editor10, editor11, editor12;
    private StringRequest stringRequest;
    private RequestQueue requestQueue;
    private Info info;
    private String url, stu_title = "Studennt Certificate";
    private PendingIntent pendingIntent;
    private String id, name, pass, photo, level, department;
    ...
    private boolean isConnected() {
        ...
        if (manager != null) {
            Ninfo = manager.getActiveNetworkInfo();
    ...
    private void checkcomments() {
        ...
        if (type.equals("student")) {
            ...
            SharedPreferences sh = getSharedPreferences("doctor", Context.MODE_PRIVATE);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
                ...
                for (int i = 0; i < listitems.size(); i++) {
                    ...
                    StringRequest request1 = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            SharedPreferences sharedcomment = getSharedPreferences(listitems.get(finalI), Context.MODE_PRIVATE);
                            ...
                            if (Integer.parseInt(sharedcomment.getString(listitems.get(finalI), "1000000000")) < Integer.parseInt(response)) {
                                ...
                                Intent intent = new Intent(ServiecesForMessageAndNotification.this, Comments.class);
                                ...
                                if (type.equals("student")) {
                                    ...
                                    SharedPreferences doctordata = getSharedPreferences("doctor", Context.MODE_PRIVATE);
                                    intent.putExtra("DName", doctordata.getString("name", "-1"));
                                    intent.putExtra("DId", doctordata.getString("id", "-1"));

                                }
                                pendingIntent = PendingIntent.getActivity(ServiecesForMessageAndNotification.this,
                                        35, intent, PendingIntent.FLAG_UPDATE_CURRENT);
                                StudentNotification.showNotification(ServiecesForMessageAndNotification.this, 40, getResources().getString(R.string.comment), pendingIntent, stu_title, getResources().getString(R.string.newcomment), getResources().getString(R.string.newcomment));
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Query databaseReference = firebaseDatabase.getReference().child(id + "").child("receiver").orderByKey()
                .limitToLast(1);
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot data : dataSnapshot.getChildren()) {
                    SendForm sendForm = data.getValue(SendForm.class);
                    Toast.makeText(ServiecesForMessageAndNotification.this, sendForm.getMessage() + "   lllllllll", Toast.LENGTH_LONG).show();
                }
            }
        ...
        Log.e("888888", "" + id + databaseReference);
            ...
            public void run() {
                try {
                    if (isConnected()) {
                        ...
                        requestQueue = Volley.newRequestQueue(ServiecesForMessageAndNotification.this);
                        ...
                        checkgroup(ServiecesForMessageAndNotification.this);
                        checkgrouppost(ServiecesForMessageAndNotification.this);
                        checktable(ServiecesForMessageAndNotification.this);
                        checkcourse(ServiecesForMessageAndNotification.this);
                        checklibraryBook(ServiecesForMessageAndNotification.this);
                        checkexams(ServiecesForMessageAndNotification.this);
                        checkcompition(ServiecesForMessageAndNotification.this);
                        checknews(ServiecesForMessageAndNotification.this);
                        checkprograms(ServiecesForMessageAndNotification.this);
                        checkcomments();
