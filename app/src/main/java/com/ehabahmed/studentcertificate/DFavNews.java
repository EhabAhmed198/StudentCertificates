...
public class DFavNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dfav_news);
    ...
    private void getfavdata() {
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.LOLLIPOP_MR1){
            url = "https://ehab01998.com/favNewsGet.php?type=1&doctor_id="+info.getDoctor_id();
        }else{
            url = "http://ehab01998.com/favNewsGet.php?type=1&doctor_id="+info.getDoctor_id();
