...
public class StudentSettings extends Fragment {
    ...
    private void putdata() {
        ...
        listitem.add(new setting_object(2, "E-Learning sites", R.drawable.ic_web_black_24dp));
        if (Integer.parseInt(studuentInfo.getLevel()) != 5)
            listitem.add(new setting_object(3, getResources().getString(R.string.table), R.drawable.tables));
        if (Integer.parseInt(studuentInfo.getLevel()) != 5)
            listitem.add(new setting_object(4, getResources().getString(R.string.result), R.drawable.result));

        listitem.add(new setting_object(5, getResources().getString(R.string.courses), R.drawable.courses));
        listitem.add(new setting_object(6, getResources().getString(R.string.library), R.drawable.library));
        if (Integer.parseInt(studuentInfo.getLevel()) != 5)
            listitem.add(new setting_object(7, getResources().getString(R.string.examp), R.drawable.exams));
        ...
        listitem.add(new setting_object(15, "Settings", R.drawable.setting1));
        listitem.add(new setting_object(16, getResources().getString(R.string.signout), R.drawable.signout));
