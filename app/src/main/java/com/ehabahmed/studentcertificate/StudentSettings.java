...
ArrayList<setting_object> listitem;
    ...
    String name=studuentInfo.getName().toUpperCase().charAt(0)+studuentInfo.getName().substring(1);
        ...
        if(Integer.parseInt(studuentInfo.getLevel())==5)
       listitem.add(new setting_object(9,getResources().getString(R.string.RequestAcertificate),R.drawable.gr));
        listitem.add(new setting_object(10,getResources().getString(R.string.compition),R.drawable.compition));
        listitem.add(new setting_object(11,getResources().getString(R.string.programs),R.drawable.programs));
        listitem.add(new setting_object(12,getResources().getString(R.string.Articles),R.drawable.articles));
        listitem.add(new setting_object(13,getResources().getString(R.string.map),R.drawable.map));
        listitem.add(new setting_object(14,getResources().getString(R.string.signout),R.drawable.signout));
